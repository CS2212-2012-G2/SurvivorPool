 ...
 * ability to add users and contestants (until the game begins), as well as handling 
 * the bonus questions.
 * 
 * @author Graem Littleton, Justin McDonald, Jonathan Demelo, Kevin Brightwell, Ramesh Raj
 *
 */
public class AdminPanel {
	 ...
	 * 
	 * @param uniqueId target user's unique id
	 * @return target user
	 */
	...
	/**
	 * addContestant adds a contestant to the array stored in 
	 * GameData.  Cannot be used if the game has begun.
	 *
	 *@param cont contestant to be added
	 */
	 ...
	 * 
	 * @param bonus  bonus question to be added
	 */
	...
	/**
	 * addUser adds a user to the array list storing the complete list of
	 * people playing Survivor Pool.
	 * 
	...
	/**
	 * removeBonusQuestion removes a specified bonus question from the array list.
	 * 
	 * @param target    desired bonus question
	 */
