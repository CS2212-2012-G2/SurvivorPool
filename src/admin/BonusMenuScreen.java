...
public class BonusMenuScreen {
	...
	public BonusMenuScreen(String Tempskin) {
		this.skin = Tempskin;
		...
		/* banner */
		textBanner = new JLabel("BONUS MENU", SwingConstants.CENTER); // large title banner
